...
ggplot(snipped_territories, aes(x = cmte_party_affiliation, y = transaction_amt, col = ge_winner)) +
  geom_jitter() +
  facet_wrap(~state.x, ncol = 3) +
  geom_point(shape = 23, alpha = .1) +
  labs(x = "Committee Party Affiliation", y = "Donation Amount", ggtitle = "Election Results Based on Territorial Donations")
